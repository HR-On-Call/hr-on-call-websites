...
$pageTitle = 'Contact HR Consultant Plymouth | Get Expert HR Support';
$pageDescription = 'Contact HR On Call for expert HR support in Plymouth, Devon and Cornwall. Book a discovery call or send us a message to discuss your HR needs.';
$pageKeywords = 'contact HR On Call, HR consultant Plymouth contact, Plymouth HR support, HR enquiry Devon, book HR consultation Plymouth';
...
<div class="oc">
  ...
  <section class="oc-hero">
    <div class="oc-wrap">
      ...
      <h1>Contact Your Plymouth HR Consultant</h1>
      <p>Ready to discuss how we can support your business with expert HR services in Plymouth, Devon and Cornwall?</p>
    </div>
  </section>
    ...
    <div class="oc-wrap">
      <div class="oc-grid3">
        ...
        <div class="oc-cardn">
          ...
          <h3>Location</h3>
          <p>Based in Plymouth<br>Serving Devon, Cornwall & UK</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="oc-sec oc-cream">
    <div class="oc-wrap oc-split" style="align-items:start;">
      ...
      <div class="contact-form-container">
        ...
        <h2 style="font-size:clamp(28px,3.4vw,40px); margin:14px 0 0;">Send Us a Message</h2>
