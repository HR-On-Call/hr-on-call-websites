...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-RC35X23FS1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
      gtag('config', 'G-RC35X23FS1');
    </script>

    <!-- Critical site styles (render-blocking, needed for above-the-fold) -->
    <link rel="stylesheet" href="/assets/css/style.css?v=20260622b">

    <!-- Preload above-the-fold self-hosted Poppins weights so the hero headline paints in-brand before LCP -->
    ...
    <!-- Preconnect to the icon CDN for the async Font Awesome load -->
    <link rel="preconnect" href="https://cdnjs.cloudflare.com" crossorigin>

    <!-- Non-critical CSS loaded async (print->all swap) so it doesn't block first paint -->
    <link rel="stylesheet" href="/assets/css/cookies.css?v=2" media="print" onload="this.media='all'">
    ...
    <script type="application/ld+json">
    {
        ...
        "founder": {
            ...
            "description": "MA in Human Resource Management (Distinction) and CIPD Level 7 qualified HR consultant specialising in employment law, workplace investigations and employee relations.",
            ...
            <nav class="main-nav">
                <div class="nav-brand">
                    <a href="<?php echo SITE_URL; ?>">
                        <img src="<?php echo SITE_URL; ?>/assets/images/hr-on-call-logo-light.webp" alt="<?php echo SITE_NAME; ?>" class="logo-image" width="263" height="78">
                    </a>
                </div>
                ...
                <div class="nav-links">
                    ...
                    <div class="nav-dropdown">
                        <a href="<?php echo SITE_URL; ?>/services.php" class="nav-link">Services <i class="fas fa-chevron-down" style="font-size:0.65rem; margin-left:4px;"></i></a>
