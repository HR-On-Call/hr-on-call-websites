        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    <img src="<?php echo SITE_URL; ?>/assets/images/hr-on-call-logo-dark.webp" alt="<?php echo SITE_NAME; ?>" class="footer-logo" width="263" height="78">
                    <p>Expert HR support for businesses in Plymouth, Devon and Cornwall.</p>
                </div>
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo SITE_URL; ?>/accountants.php">Referral Scheme</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo SITE_URL; ?>/pay-as-you-go.php">HR Projects</a></li>
                        <li><a href="<?php echo SITE_URL; ?>/employment-rights-act">Employment Rights Act 2025</a></li>
                        <li><a href="<?php echo SITE_URL; ?>/hr-consultant-devon.php">HR Consultant Devon</a></li>
                        <li><a href="<?php echo SITE_URL; ?>/hr-consultant-cornwall.php">HR Consultant Cornwall</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        ...
                        <li style="margin-top: 10px; font-size: 0.85rem; color: rgba(255,255,255,0.5);">Registered: <?php echo REGISTERED_OFFICE; ?></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="footer-bottom">
                ...
                Registered office: <?php echo REGISTERED_OFFICE; ?>.<br>
                VAT number: 515981373.</p>
                ...
                <p style="margin-top:12px;">
                    <iframe src="https://registry.blockmarktech.com/certificates/65075c56-85b4-4d09-8677-47cd2f1de252/widget/?tooltip_position=bottom_right&amp;theme=transparent&amp;hover=t" width="120" height="120" frameborder="0" scrolling="no" style="border:0; background:transparent; display:inline-block;" title="Cyber Essentials certified"></iframe>
                </p>
            </div>
        </div>
    </footer>
