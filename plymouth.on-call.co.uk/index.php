  ...
  <section class="oc-sec" style="background:#FBF8F2; border-top:1px solid #EFEADF; border-bottom:1px solid #EFEADF;">
    <div class="oc-wrap oc-split">
      <div style="text-align:center;">
        <img src="/assets/images/grace-headshot-2026.jpg" width="400" height="400" alt="Grace Pariser HR Consultant" loading="lazy" style="width:230px; height:230px; border-radius:50%; object-fit:cover; box-shadow:0 18px 44px rgba(16,30,51,.18); display:inline-block;">
