  ...
  <section class="oc-sec">
    <div class="oc-wrap oc-split">
      <div style="text-align:center;">
        <img src="assets/images/grace-headshot-2026.jpg" alt="Grace Pariser, HR Consultant" loading="lazy" style="width:80%; margin:0 auto; box-shadow:0 18px 44px rgba(16,30,51,.16);">
